...
@section('title', 'Request Logs Report')
                    ...
                    <table class="table report-table pb-3 fs-14 table-bordered" style="border-color: #343a40;">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th style="background-color: #f0f0f0;">Action By</th>
                                <th style="background-color: #f0f0f0;">Log Date</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-generate').on('click', function () {
                ...
                window.open('/request-logs-report-pdf?year=' + year + '&fund_source_id=' + fund_source_id + '&month=' + month, '_blank');
            });

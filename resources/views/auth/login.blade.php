        ...
        <div class="login-wrapper login-new">
            <div class="container">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="login-userset">
                            <div class="login-userheading">
                                <h3>Sign In</h3>
                                <h4>Access the back office panel using your email and passcode.</h4>
                            </div>
                            @if ($errors->any())
                ...
                <div class="my-4 d-flex justify-content-center align-items-center copyright-text">
                    <p>Copyright &copy; 2025 Koronadal City. All rights reserved <a href="www.facebook.com">Bray</a></p>
                </div>
            </div>
        </div>
    </div>
